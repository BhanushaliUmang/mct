...
public interface UserRepository extends JpaRepository<Users,Integer>{
    ...
    @Query(value="select * from tbl_user where username = :username and status_id=2", nativeQuery=true)
    public List<Users> findByUsername(String username);

    @Query(value = "select * from tbl_user where user_id = :userId and status_id = 2", nativeQuery = true)
